...
- Litematica：也就是投影模组，可以给你预先建造好的建筑生成一个投影文件，或者你可以在网上下载别人的投影文件，然后将文件导入游戏，就可以在服务器中显示这个建筑的投影，你接下来的工作就是照着投影一层一层逐步放置方块就行，这对大型建筑的建造十分有用！关于本mod的教程可以去b站搜索，上面已经有一万个视频讲这个了。。。
